...
<div class="container-fluid h-100" style="padding: 0; background: white;">
    ...
    <p style="width: 100%; text-align: center; font-size: 20px; padding-top: 15px">Fotos <br> 1/3</p>

    <a href="{{ route('evidencias2.index') }}"><button style="width: 70%; margin-left: 17.5%; padding:8px; margin-top: 20px;  border-radius: 40px; background: white; border: none; color: grey; text-align: center; border:solid; border-color:gray; border-width: 1px">Continuar</button></a>
